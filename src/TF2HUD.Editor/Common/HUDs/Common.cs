        ...
        public static bool ItemColors()
        {
            try
            {
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorNormal")] =
                    $"\t\t\"DimmQualityColorNormal\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_normal, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorUnique")] =
                    $"\t\t\"DimmQualityColorUnique\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_unique, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorStrange")] =
                    $"\t\t\"DimmQualityColorStrange\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_strange, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorVintage")] =
                    $"\t\t\"DimmQualityColorVintage\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_vintage, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorHaunted")] =
                    $"\t\t\"DimmQualityColorHaunted\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_haunted, true)}\"";

                lines[Utilities.FindIndex(lines, "\"QualityColorNormal\"")] =
                    $"\t\t\"QualityColorNormal\"\t\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_genuine)}\"";
                lines[Utilities.FindIndex(lines, "DimmQualityColorNormal")] =
                    $"\t\t\"DimmQualityColorNormal\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_genuine, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorCollectors")] =
                    $"\t\t\"DimmQualityColorCollectors\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_collectors, true)}\"";

                lines[Utilities.FindIndex(lines, "\"QualityColorNormal\"")] =
                    $"\t\t\"QualityColorNormal\"\t\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_unusual)}\"";
                lines[Utilities.FindIndex(lines, "DimmQualityColorNormal")] =
                    $"\t\t\"DimmQualityColorNormal\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_unusual, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorCommunity")] =
                    $"\t\t\"DimmQualityColorCommunity\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_community, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmQualityColorDeveloper")] =
                    $"\t\t\"DimmQualityColorDeveloper\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_valve, true)}\"";
                // Rarity
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityDefault")] =
                    $"\t\t\"DimmItemRarityDefault\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_civilian, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityCommon")] =
                    $"\t\t\"DimmItemRarityCommon\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_freelance, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityUncommon")] =
                    $"\t\t\"DimmItemRarityUncommon\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_mercenary, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityRare")] =
                    $"\t\t\"DimmItemRarityRare\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_commando, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityMythical")] =
                    $"\t\t\"DimmItemRarityMythical\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_assassin, true)}\"";
                ...
                lines[Utilities.FindIndex(lines, "DimmItemRarityLegendary")] =
                    $"\t\t\"DimmItemRarityLegendary\"\t\t\t\t\"{Utilities.RgbConverter(flawhud.Default.color_elite, true)}\"";
                File.WriteAllLines(file, lines);
                return true;
            }
            catch (Exception ex)
